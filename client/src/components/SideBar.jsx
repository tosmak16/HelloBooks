...
class SideBar extends React.Component {
  /**
   * Creates and initializes instance of SideBar.
   * @param {object} props
   * @memberof SideBar
   */
  constructor(props) {
   ...
   */
  handleClick(event) {
    this.props.showbooksByCategory(event.target.name, this.props.bookData);
  }
  /**
   * @param {object} event
   ...
   * @returns
   * @memberof SideBar
   * @returns {views} with collaspsible list
   */
  render() {
    return (
      <div className="row">
